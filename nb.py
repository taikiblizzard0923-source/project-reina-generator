...
def edit(
    ...
    **opts,
    ...
    image を省略すると、最後に生成した画像を直す。指示は具体的な英語が通りやすい。
    raw=True で「それ以外は変えない」の定型文を付けずに指示文だけを渡す。
        edit("Change the white T-shirt to a navy blue T-shirt.")
        edit("Change the background to a cafe by the window.", image="output/.../shot_777.png")
    """
...
print(
    ...
    '  /  edit("Change the T-shirt to navy blue.")'
